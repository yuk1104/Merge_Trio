...
class LanguageManager extends ChangeNotifier {
  ...
  static final Map<String, String> _japaneseTranslations = {
    ...
    'unlock_neon_description': '4×4でハイスコアを達成してネオンスキンをアンロック！\n\n鮮やかなネオンカラーがプレイを彩ります。',
    'your_best_score': 'あなたのベストスコア (4×4)',
    'required': '必要',
    'progress': '進捗',
    'achieve_score': 'スコア',
    'share_progress': '招待進捗',
    ...
    'tap_for_current_week': 'タップして今週に戻る',
    'rank': '順位',
    'player': 'プレイヤー',
    'loading': '読み込み中...',
  ...
  static final Map<String, String> _englishTranslations = {
    ...
    'unlock_neon_description': 'Achieve a high score in 4×4 mode to unlock the Neon skin!\n\nVibrant neon colors will brighten up your gameplay.',
    'your_best_score': 'Your Best Score (4×4)',
    'required': 'Required',
    'progress': 'Progress',
    'achieve_score': 'Score',
    ...
    'tap_for_current_week': 'Tap to return to current week',
    'rank': 'Rank',
    'player': 'Player',
    'loading': 'Loading...',
